...
#> Summon particle
execute at @s run function delta:internal/effects/particle/explosion/spawn

scoreboard players remove $count delta.api.particle 1
execute if score $count delta.api.particle matches 1.. run function delta:internal/effects/particle/explosion/spread_2